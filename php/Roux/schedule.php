			...
			<div class="principal-A">
				<main>
					<section class="seccion1">
						<h2 class="subtitulo">Schedule</h2>
					...
					<h3 class="fecha">Monday, March 7,2016</h3>
					<h2 class="title-artist"> Art in Full Color</h2>
					...
					<section class= "artist-desc-S">
						...
						<div>
						<h2 class="title-artist">Art in Unexpected Places</h2>
						<h3 class="t-gris"> 09:30-10:30am: ELizabeth Hall</h3>
						<p>
							Labeled as “The Artist to Watch in 2016” by the London Review, Johnathan has already sold one of the highest priced commissions paid to an art student, ever on record. The piece, entitled Gratitude Resort, a work in oil and mixed media, was sold for $750,000.
						</p>
						</div>
					</section>
					...
					<div>
					<h2 class="title-artist"> Art in Full Bloom</h2>
					<h3 class="t-gris"> 11:00am-1pm: Victoria Hall</h3>
						<p>
					...
					<div>
					<h2 class="title-artist"> Still Life</h2>
					<h3 class="t-gris"> 2:30-4:00pm: Dennison Hall</h3>
						<p>
					...
					<section>
						<h3 class="fecha">Tuesday March 8,2016</h3>
						<h2>Water in Art</h2>
						<p>
					...
					<section class= "artist-desc-S">
						...
						<div>
						<h2 class="title-artist"> Water in Art Kickoff Session</h2>
						<h3 class="t-gris"> 09:30-10:30am: Elizabeth Hall</h3>
						<p>
					...
					<section class= "artist-desc-S">
						...
						<div>
						<h2 class="title-artist"> Ice Sculputures</h2>
						<h3 class="t-gris"> 10:30-1pm: Fountain of Intrigue</h3>
						<p>
